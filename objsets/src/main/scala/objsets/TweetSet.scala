...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
    ...
    def filterAcc(p: Tweet => Boolean, acc: TweetSet): TweetSet = {
//      if (left.isEmpty && right.isEmpty) if (p(elem)) acc incl elem else acc
...
//      else left.filterAcc(p, acc) union right.filterAcc(p, acc)
        ...
        if (left.isEmpty && right.isEmpty) if (p(elem)) acc incl elem else acc
        else if (p(elem)) remove(elem).filterAcc(p, acc incl elem)
        else this.remove(elem).filterAcc(p, acc)
        
//      if (this.left.isEmpty && this.right.isEmpty) if (p(this.elem)) acc.incl(this.elem) else acc
//      else if (this.left.isEmpty) if (p(this.elem)) this.right.filterAcc(p, acc.incl(this.elem)) else this.right.filterAcc(p, acc)
//      else if (this.right.isEmpty) if (p(this.elem)) this.left.filterAcc(p, acc.incl(this.elem)) else this.left.filterAcc(p, acc)
//      else if (p(this.elem)) this.left.filterAcc(p, acc.incl(this.elem)) union this.right.filterAcc(p, acc.incl(this.elem)) remove this.elem
